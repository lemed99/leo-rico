...
converters.DeclareClass = function (context, path) {
  ...
  if (typeParameters.length > 0) {
    var _ret = function () {
      ...
      return {
        v: context.call('declare', context.call('class', t.stringLiteral(name), t.arrowFunctionExpression([uid], t.blockStatement([t.variableDeclaration('const', typeParameters.map(function (typeParameter) {
  ...
  if (shouldBox) {
    ...
    try {
      for (var _iterator4 = typeParameters[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        declarations.push(t.variableDeclaration('const', [t.variableDeclarator(t.identifier(_name), t.callExpression(t.memberExpression(fn, t.identifier('typeParameter')), args))]));
      }
    } catch (err) {
  ...
  if (shouldBox) {
    ...
    try {
      for (var _iterator6 = typeParameters[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        declarations.push(t.variableDeclaration('const', [t.variableDeclarator(t.identifier(_name2), t.callExpression(t.memberExpression(classId, t.identifier('typeParameter')), args))]));
      }
    } catch (err) {
